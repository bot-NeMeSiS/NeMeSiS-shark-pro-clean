...
require(version in {VERSION, V778_VERSION, V779_VERSION}, f"VERSION.txt debe ser V777/V778/V779 compatible, es {version}")
app = read("app.py")
require(f'APP_VERSION = "{VERSION}"' in app or f'APP_VERSION = "{V778_VERSION}"' in app or f'APP_VERSION = "{V779_VERSION}"' in app, "APP_VERSION no actualizado")
