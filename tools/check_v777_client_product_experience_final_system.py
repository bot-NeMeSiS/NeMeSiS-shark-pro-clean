...
require(version == VERSION, f"VERSION.txt debe ser {VERSION}, es {version}")
app = read("app.py")
require(f'APP_VERSION = "{VERSION}"' in app, "APP_VERSION no actualizado")
...
require("v777-client-rail" in base, "falta rail cliente V777")
...
for token in ["Centro de mando", "Ruta recomendada", "Partidos/focos", "Picks claros", "Sin inventar"]:
...
for token in ["V777_CLIENT_PRODUCT_EXPERIENCE_FINAL_SYSTEM", ".v777-client-rail", ".v777-intent-grid", "@media (max-width: 760px)"]:
