...
require(version in {VERSION, V778_VERSION, V779_VERSION, V780_VERSION, V781_VERSION, V782_VERSION, V783_VERSION}, f"VERSION.txt debe ser V777/V778/V779/V780 compatible, es {version}")
app = read("app.py")
