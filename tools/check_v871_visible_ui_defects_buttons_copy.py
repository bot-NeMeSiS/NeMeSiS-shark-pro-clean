...
VERSION = "V871_VISIBLE_UI_DEFECTS_BUTTONS_COPY_AND_REAL_PROGRESS_FIX_FINAL"
ZIP_NAME = f"NeMeSiS_SHARK_PRO_{VERSION}_RENDER_READY.zip"

REPORTS = [
    "V871_PREFLIGHT_FROM_V870.md",
    "V871_VISIBLE_UI_DEFECTS_BUTTONS_COPY_AND_REAL_PROGRESS_FIX_REPORT.md",
    "V871_BUTTONS_COPY_DUPLICATION_AUDIT.md",
    "V871_UI_COMPONENTS_MACRO_FIX_REPORT.md",
    "V871_NAVIGATION_DUPLICATION_FIX_REPORT.md",
    "V871_CLIENT_VISIBLE_UI_FIX_QA.md",
    "V871_ADMIN_VISIBLE_UI_FIX_QA.md",
    "V871_REAL_PROGRESS_VISIBILITY_AUDIT.md",
    "V871_SENTINEL_VISIBLE_UI_RULES_QA.md",
...
def fail(message: str) -> None:
    raise SystemExit(f"V871 visible UI defects check FAILED: {message}")
...
def main() -> None:
    ...
    require("has_v871_visible_ui_defects_buttons_copy_fix" in app_py, "runtime V871 flag missing")
    require("V871 VISIBLE UI DEFECTS BUTTONS COPY REAL PROGRESS FIX START" in css, "CSS V871 marker missing")
    ...
    require(payload.get("has_v871_visible_ui_defects_buttons_copy_fix") is True, "runtime V871 flag false")
    ...
    print("V871 visible UI defects/buttons/copy OK")
