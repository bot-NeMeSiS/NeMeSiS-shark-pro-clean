...
ok("version_v766", version in {"V766_CALENDAR_RESULTS_HIGHLIGHTS_ORDER_AUTOMATION", "V767_MADRID_TIME_EVERYWHERE_CERTIFICATION", "V768_PICK_RESULTS_TRACK_RECORD_TELEGRAM_PRODUCTION_CERTIFICATION", "V769_HIGHLIGHTS_RESULTS_CONTENT_CENTER_FINAL"})
ok("app_version_v766", ('APP_VERSION = "V766_CALENDAR_RESULTS_HIGHLIGHTS_ORDER_AUTOMATION"' in APP or 'APP_VERSION = "V767_MADRID_TIME_EVERYWHERE_CERTIFICATION"' in APP or 'APP_VERSION = "V768_PICK_RESULTS_TRACK_RECORD_TELEGRAM_PRODUCTION_CERTIFICATION"' in APP or 'APP_VERSION = "V769_HIGHLIGHTS_RESULTS_CONTENT_CENTER_FINAL"' in APP))
...
ok("match_detail_highlights", (('v766-match-highlights' in MATCH or 'v769-match-highlights' in MATCH) and ('rehostea' in MATCH)))
