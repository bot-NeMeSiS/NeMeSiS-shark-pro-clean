...
def main():
    ...
    assert_true(current_version in {VERSION, "V750_CLIENT_LIVE_DAY_RELEVANCE_MADRID_RESULT_POLISH", "V751_TELEGRAM_PICK_ULTRA_PRO_MESSAGE_EXPERIENCE", "V752_TELEGRAM_FULL_AUTO_ARTILLERY_PRODUCTION_CERTIFICATION"}, "VERSION.txt no contiene V749B/V750/V751/V752.")
