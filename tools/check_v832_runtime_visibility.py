...
def main() -> int:
    os.environ.setdefault("DB_PATH", str(ROOT / "data" / "v832_check_runtime.db"))
    os.environ.setdefault("AUTOMATION_SECRET", "codex-v832-secret")
    os.environ.setdefault("SECRET_KEY", "codex-v832-secret-key")
