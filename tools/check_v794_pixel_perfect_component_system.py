...
require(version in ["V794_PIXEL_PERFECT_CLIENT_ADMIN_COMPONENT_SYSTEM", "V795_MOCKUP_FIDELITY_LIVING_UI_DEEP_POLISH"], f"VERSION inesperada: {version}")
require(("V794_PIXEL_PERFECT_CLIENT_ADMIN_COMPONENT_SYSTEM" in app) or ("V795_MOCKUP_FIDELITY_LIVING_UI_DEEP_POLISH" in app), "APP_VERSION no actualizado compatible V794/V795")
