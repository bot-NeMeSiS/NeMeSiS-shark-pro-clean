...
ALLOWED_VERSIONS = ['V800_REFERENCE_SCREEN_APP_FIDELITY_REAL_DATA_NAVIGATION_FINAL', 'V801_CALENDAR_MATCHES_REFERENCE_FLOW_REAL_DATA_PERFECTION', 'V802_CLIENT_REFERENCE_FLOW_LINKED_EXPERIENCE_PERFECTION', 'V803_API_FOOTBALL_LIVE_TRACKER_REFERENCE_EXPERIENCE', 'V804_API_FOOTBALL_LIVE_DEEP_TRACKER_PRESSURE_FIELD_FINAL', 'V805_API_FOOTBALL_LIVE_OPERATIONS_CLIENT_PERFECTION']
