...
def main() -> None:
    ...
    require(read("VERSION.txt").strip() == VERSION, "VERSION.txt is not V878")
    require(read("APP_VERSION").strip() == VERSION, "APP_VERSION is not V878")
    require(f"APP_VERSION = '{VERSION}'" in app_py, "app.py APP_VERSION is not V878")
    require(VERSION in base, "base.html missing V878 cache/version")
