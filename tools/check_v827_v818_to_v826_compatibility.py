...
def main() -> int:
    checks={
        ...
        'v826_full_screen_preserved':'data-v826-shell="true"' in base and 'V826 FULL REFERENCE EXPERIENCE START' in css,
        'v827_active':'data-v827-shell="true"' in base and 'V827 REFERENCE PHOTO REBUILD DESIGN SYSTEM START' in css,
        'db_path_unchanged':'DB_PATH' in app and '/data/database.db' in app,
        'crest_routes_light': all(x in app for x in ['/asset/team-logo/', '/asset/league-logo/', '/team-crest.svg']),
    }
