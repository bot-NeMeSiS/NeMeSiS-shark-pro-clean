...
def main() -> None:
    ...
    ok(version_txt in {VERSION, NEXT_VERSION, V864, V865, V866, V867, V868}, "VERSION.txt V862 continuous/V863/V868", failures)
    ok(any(f"APP_VERSION = '{candidate}'" in app_py for candidate in {VERSION, NEXT_VERSION, V864, V865, V866, V867, V868}), "APP_VERSION V862 continuous/V863/V868", failures)
