...
def main() -> None:
    ...
    require(version_txt == VERSION, "VERSION.txt not V866")
    require(app_version == VERSION, "APP_VERSION not V866")
    require(f"APP_VERSION = '{VERSION}'" in app_py, "app.py APP_VERSION not V866")
