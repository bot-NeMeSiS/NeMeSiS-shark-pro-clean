...
require(VERSION.startswith(("V787_LEGAL_COMPLIANCE_RESPONSIBLE_SUBSCRIPTION_READY", "V788_LEGAL_COMPLIANCE_LIVE_READABILITY_TOTAL_POLISH")), f"VERSION inesperada: {VERSION}")
require(('APP_VERSION = "V787_LEGAL_COMPLIANCE_RESPONSIBLE_SUBSCRIPTION_READY"' in app) or ('APP_VERSION = "V788_LEGAL_COMPLIANCE_LIVE_READABILITY_TOTAL_POLISH"' in app), "APP_VERSION no actualizado")
