...
require(VERSION.startswith(("V787_LEGAL_COMPLIANCE_RESPONSIBLE_SUBSCRIPTION_READY", "V788_LEGAL_COMPLIANCE_LIVE_READABILITY_TOTAL_POLISH", "V789_REAL_LAUNCH_CERTIFICATION_COMMAND_CENTER", "V790_CLIENT_PROFESSIONAL_SCREEN_SYSTEM_TOTAL_POLISH", "V791_FULL_APP_REAL_AUDIT_CLIENT_PERFECTION_FINAL", "V792_CLIENT_MOCKUP_VISUAL_SYSTEM_IMPLEMENTATION")), f"VERSION inesperada: {VERSION}")
require(('APP_VERSION = "V792_CLIENT_MOCKUP_VISUAL_SYSTEM_IMPLEMENTATION"' in app or 'APP_VERSION = "V791_FULL_APP_REAL_AUDIT_CLIENT_PERFECTION_FINAL"' in app) or ('APP_VERSION = "V788_LEGAL_COMPLIANCE_LIVE_READABILITY_TOTAL_POLISH"' in app), "APP_VERSION no actualizado")
