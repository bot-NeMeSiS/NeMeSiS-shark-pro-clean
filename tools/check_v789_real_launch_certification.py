...
require(version.startswith('V789_REAL_LAUNCH_CERTIFICATION_COMMAND_CENTER') or version.startswith('V790_CLIENT_PROFESSIONAL_SCREEN_SYSTEM_TOTAL_POLISH'), f'VERSION inesperada: {version}')
