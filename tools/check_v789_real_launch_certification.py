...
require(version.startswith('V789_REAL_LAUNCH_CERTIFICATION_COMMAND_CENTER') or version.startswith('V790_CLIENT_PROFESSIONAL_SCREEN_SYSTEM_TOTAL_POLISH') or version.startswith('V791_FULL_APP_REAL_AUDIT_CLIENT_PERFECTION_FINAL') or version.startswith('V792_CLIENT_MOCKUP_VISUAL_SYSTEM_IMPLEMENTATION') or version.startswith('V792_CLIENT_MOCKUP_VISUAL_SYSTEM_IMPLEMENTATION') or version.startswith('V791_FULL_APP_REAL_AUDIT_CLIENT_PERFECTION_FINAL') or version.startswith('V792_CLIENT_MOCKUP_VISUAL_SYSTEM_IMPLEMENTATION') or version.startswith('V792_CLIENT_MOCKUP_VISUAL_SYSTEM_IMPLEMENTATION'), f'VERSION inesperada: {version}')
