...
def main() -> None:
    ...
    ok(version_txt in {VERSION, NEXT_VERSION, NEXT_NEXT_VERSION, NEXT_NEXT_NEXT_VERSION, NEXT_NEXT_NEXT_NEXT_VERSION}, "VERSION.txt V859/V860/V861/V862", failures)
    ok(any(f"APP_VERSION = '{candidate}'" in app_py for candidate in {VERSION, NEXT_VERSION, NEXT_NEXT_VERSION, NEXT_NEXT_NEXT_VERSION, NEXT_NEXT_NEXT_NEXT_VERSION}), "APP_VERSION V859/V860/V861/V862", failures)
