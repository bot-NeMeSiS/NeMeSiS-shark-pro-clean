...
def main() -> None:
    ...
    ok(version_txt == VERSION, "VERSION.txt V859", failures)
    ok(f"APP_VERSION = '{VERSION}'" in app_py, "APP_VERSION V859", failures)
    ...
    ok("V859_COMPANY_WIDE_ECOSYSTEM_AUDIT_AND_PRODUCT_BOARD_FINAL" in base, "cache CSS V859", failures)
