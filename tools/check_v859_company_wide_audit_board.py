...
def main() -> None:
    ...
    ok(version_txt in {VERSION, NEXT_VERSION, NEXT_NEXT_VERSION, NEXT_NEXT_NEXT_VERSION, NEXT_NEXT_NEXT_NEXT_VERSION, V863}, "VERSION.txt V859/V860/V861/V862/V863", failures)
    ok(any(f"APP_VERSION = '{candidate}'" in app_py for candidate in {VERSION, NEXT_VERSION, NEXT_NEXT_VERSION, NEXT_NEXT_NEXT_VERSION, NEXT_NEXT_NEXT_NEXT_VERSION, V863}), "APP_VERSION V859/V860/V861/V862/V863", failures)
