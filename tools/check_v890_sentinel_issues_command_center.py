...
def main() -> int:
    ...
    require(version_txt.startswith(VERSION_PREFIXES), "VERSION.txt is not V890/V892 Sentinel issues lineage", failures)
    ...
    if failures:
        print("V890/V892 Sentinel issues command center check FAILED:")
        for failure in failures:
            print(f"- {failure}")
        return 1
    print("V890/V892 Sentinel issues command center check OK")
    return 0
