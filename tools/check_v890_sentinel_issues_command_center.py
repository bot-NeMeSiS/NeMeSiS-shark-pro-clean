...
VERSION_PREFIXES = ("V890_", "V892_", "V893_", "V894_", "V895_")
...
def main() -> int:
    ...
    require(version_txt.startswith(VERSION_PREFIXES), "VERSION.txt is not V890/V892/V893/V894/V895 Sentinel issues lineage", failures)
