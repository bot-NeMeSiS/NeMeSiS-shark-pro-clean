...
def check() -> dict:
    ...
    checks = []
    checks.append({"name": "version_txt", "ok": version_txt in {BASE_VERSION, current_version} and (version_txt.startswith("V735_") or version_txt.startswith("V736_") or version_txt.startswith("V737_")), "value": version_txt})
