...
def static_checks():
    ...
    ok(version in {VERSION, V774_VERSION, V775_VERSION, V776_VERSION, V777_VERSION, V778_VERSION, V779_VERSION, V780_VERSION, V781_VERSION, V782_VERSION, V783_VERSION}, "VERSION.txt no apunta a V773/V774/V775/V776/V777/V778/V779/V780/V781/V782/V782 compatible", version)
    ok(f'APP_VERSION = "{VERSION}"' in app or f'APP_VERSION = "{V774_VERSION}"' in app or f'APP_VERSION = "{V775_VERSION}"' in app or f'APP_VERSION = "{V776_VERSION}"' in app or f'APP_VERSION = "{V777_VERSION}"' in app or f'APP_VERSION = "{V778_VERSION}"' in app or f'APP_VERSION = "{V779_VERSION}"' in app or f'APP_VERSION = "{V780_VERSION}"' in app or f'APP_VERSION = "{V781_VERSION}"' in app or 'APP_VERSION = "V782_STRIPE_REAL_SUBSCRIPTIONS_MEMBERSHIP_BILLING"' in app or 'APP_VERSION = "V783_HOME_MEMBERSHIP_CLIENT_EXPERIENCE_COMPACT_FINAL"' in app, "APP_VERSION no apunta a V773/V774/V775/V776/V777/V778/V779/V780/V781/V782/V782 compatible")
