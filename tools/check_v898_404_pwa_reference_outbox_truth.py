...
def main() -> int:
    ...
    require(read("VERSION.txt").strip().lstrip("\ufeff") in CURRENT_ALLOWED, "VERSION.txt is not V898/V899/V900", failures)
    require(read("APP_VERSION").strip().lstrip("\ufeff") in CURRENT_ALLOWED, "APP_VERSION file is not V898/V899/V900", failures)
    require(app_version_from_source(app_py) in CURRENT_ALLOWED, "app.py APP_VERSION is not V898/V899/V900", failures)
    require(("data-v898-shell" in base or "data-v899-shell" in base or "data-v900-shell" in base), "base V898/V899/V900 marker missing", failures)
    ...
    require("NEMESIS_CACHE_V898" in app_py or "NEMESIS_CACHE_V899" in app_py or "NEMESIS_CACHE_V900" in app_py, "service worker cache V898/V899/V900 missing", failures)
    ...
    require(sw.status_code == 200 and ("NEMESIS_CACHE_V898" in sw_text or "NEMESIS_CACHE_V899" in sw_text or "NEMESIS_CACHE_V900" in sw_text), "service worker V898/V899/V900 unavailable", failures)
