...
ok(version == VERSION, "VERSION.txt apunta a V760")
app_py = (ROOT / "app.py").read_text(encoding="utf-8")
ok(f'APP_VERSION = "{VERSION}"' in app_py, "APP_VERSION actualizado")
...
ok('<a href="/app">Inicio</a>' in base and '<a href="/track-record">Histórico</a>' in base, "navegación cliente simplificada")
...
ok("v760-client-home-hero" in home and "Tu día SHARK, ordenado y sin ruido" in home, "home cliente reordenado")
