...
ok(version==VERSION or version=='V768_PICK_RESULTS_TRACK_RECORD_TELEGRAM_PRODUCTION_CERTIFICATION','VERSION.txt apunta a V763 o posterior compatible')
app=(ROOT/'app.py').read_text(encoding='utf-8')
ok(f'APP_VERSION = "{VERSION}"' in app or 'APP_VERSION = "V768_PICK_RESULTS_TRACK_RECORD_TELEGRAM_PRODUCTION_CERTIFICATION"' in app,'APP_VERSION V763 o posterior compatible')
