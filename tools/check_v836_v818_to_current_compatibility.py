...
def main() -> int:
    os.environ.setdefault("DB_PATH", str(ROOT / "data" / "v836_compat.db"))
    os.environ.setdefault("SECRET_KEY", "codex-v836-compat-secret")
    ...
    health = client.get("/api/automation/health-check?secret=codex-v836-secret").status_code
