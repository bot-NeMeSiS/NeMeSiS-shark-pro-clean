...
require(version.startswith('V790_CLIENT_PROFESSIONAL_SCREEN_SYSTEM_TOTAL_POLISH') or version.startswith('V791_FULL_APP_REAL_AUDIT_CLIENT_PERFECTION_FINAL'), f'VERSION inesperada: {version}')
