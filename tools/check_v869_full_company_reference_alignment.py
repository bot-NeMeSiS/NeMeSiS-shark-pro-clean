...
def main() -> None:
    ...
    require(read("VERSION.txt").strip() == VERSION, "VERSION.txt is not V869")
    require(read("APP_VERSION").strip() == VERSION, "APP_VERSION is not V869")
    require(f"APP_VERSION = '{VERSION}'" in app_py, "app.py APP_VERSION is not V869")
    require(VERSION in base, "base.html missing V869 cache/version")
    ...
    require(payload.get("app_version") == VERSION, "runtime app_version not V869")
    require(payload.get("version_txt") == VERSION, "runtime version_txt not V869")
