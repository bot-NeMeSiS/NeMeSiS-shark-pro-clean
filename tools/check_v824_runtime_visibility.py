...
def main() -> int:
    ...
    checks = {
        "version_txt_v824": read("VERSION.txt").strip() == VERSION,
        "app_version_v824": f"APP_VERSION = '{VERSION}'" in app or f'APP_VERSION = "{VERSION}"' in app,
        "base_meta_v824": f'name="nemesis-version" content="{VERSION}"' in base,
        "base_cache_v824": f"?v={VERSION}" in base,
