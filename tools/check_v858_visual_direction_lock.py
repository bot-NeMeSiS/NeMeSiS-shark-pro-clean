...
VALID_CURRENT_VERSIONS = {VERSION, NEXT_VERSION}
...
def main() -> None:
    ...
    ok("V858_VISUAL_DIRECTION_LOCK_FULL_APP_REFERENCE_FINAL" in base or "V859_COMPANY_WIDE_ECOSYSTEM_AUDIT_AND_PRODUCT_BOARD_FINAL" in base, "cache CSS V858/V859", failures)
