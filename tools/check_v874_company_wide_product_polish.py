...
def main() -> None:
    ...
    require(read("VERSION.txt").strip() == VERSION, "VERSION.txt is not V874")
    require(read("APP_VERSION").strip() == VERSION, "APP_VERSION is not V874")
    require(f"APP_VERSION = '{VERSION}'" in app_py, "app.py APP_VERSION is not V874")
    require(VERSION in base, "base.html missing V874 cache/version")
    ...
    require(payload.get("app_version") == VERSION, "runtime app_version not V874")
    require(payload.get("version_txt") == VERSION, "runtime version_txt not V874")
