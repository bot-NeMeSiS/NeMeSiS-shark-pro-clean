...
CURRENT_COMPATIBLE_PREFIXES = ("V891_", "V892_")
...
def main() -> int:
    ...
    require(version_txt.startswith(CURRENT_COMPATIBLE_PREFIXES), "VERSION.txt is not compatible with V891/V892 lineage", failures)
