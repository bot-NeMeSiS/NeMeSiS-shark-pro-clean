...
CURRENT_COMPATIBLE_PREFIXES = ("V888_", "V889_", "V890_", "V891_", "V892_", "V893_", "V894_")
...
def main() -> int:
    ...
    require(version_txt.startswith(CURRENT_COMPATIBLE_PREFIXES), "VERSION.txt is not compatible with V888-V894 lineage", failures)
