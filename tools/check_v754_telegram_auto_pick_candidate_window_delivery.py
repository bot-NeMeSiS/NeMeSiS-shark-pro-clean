...
def static_checks() -> None:
    ...
    check("version_v754", version in {VERSION, V755_VERSION, FUTURE_VERSION, NEXT_VERSION, V758_VERSION, V759_VERSION, V760_VERSION, V761_VERSION}, version)
    check("app_version_v754", f'APP_VERSION = "{VERSION}"' in app_source or f'APP_VERSION = "{V755_VERSION}"' in app_source or f'APP_VERSION = "{FUTURE_VERSION}"' in app_source or f'APP_VERSION = "{NEXT_VERSION}"' in app_source or f'APP_VERSION = "{V758_VERSION}"' in app_source or f'APP_VERSION = "{V759_VERSION}"' in app_source or f'APP_VERSION = "{V760_VERSION}"' in app_source or f'APP_VERSION = "{V761_VERSION}"' in app_source)
