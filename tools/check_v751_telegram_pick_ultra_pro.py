...
if version not in {
    ...
    "V754_TELEGRAM_AUTO_PICK_CANDIDATE_WINDOW_DELIVERY_FIX", "V756_CLIENT_APP_PREMIUM_EXPERIENCE_TOTAL_POLISH", "V757_GLOBAL_APP_EXPERIENCE_TRUST_NAVIGATION_POLISH",
}:
