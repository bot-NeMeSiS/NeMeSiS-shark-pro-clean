...
require(version == 'V780_LIVE_DATA_RECOVERY_REALTIME_STABILITY_FIX', f'VERSION.txt incorrecto: {version}')
require('APP_VERSION = "V780_LIVE_DATA_RECOVERY_REALTIME_STABILITY_FIX"' in app, 'APP_VERSION no apunta a V780')
