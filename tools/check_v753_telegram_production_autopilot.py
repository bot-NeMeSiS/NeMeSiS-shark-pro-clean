...
def static_checks() -> None:
    ...
    check("version_v753_or_newer", version in {VERSION, CURRENT_VERSION, FUTURE_VERSION, NEXT_VERSION}, version)
    check("app_version_v753_or_newer", f'APP_VERSION = "{VERSION}"' in app_source or f'APP_VERSION = "{CURRENT_VERSION}"' in app_source or f'APP_VERSION = "{FUTURE_VERSION}"' in app_source or f'APP_VERSION = "{NEXT_VERSION}"' in app_source)
