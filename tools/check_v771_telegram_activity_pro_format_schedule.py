...
def static_checks():
    ...
    app = read("app.py")
    ok(version in {VERSION, V772_VERSION, V773_VERSION, V774_VERSION, V775_VERSION, V776_VERSION, V777_VERSION, V778_VERSION}, "VERSION.txt no apunta a V771/V772/V773/V774/V775/V776/V777/V778 compatible")
    ok(f'APP_VERSION = "{VERSION}"' in app or f'APP_VERSION = "{V772_VERSION}"' in app or f'APP_VERSION = "{V773_VERSION}"' in app or f'APP_VERSION = "{V774_VERSION}"' in app or f'APP_VERSION = "{V775_VERSION}"' in app or f'APP_VERSION = "{V776_VERSION}"' in app or f'APP_VERSION = "{V777_VERSION}"' in app or f'APP_VERSION = "{V778_VERSION}"' in app, "APP_VERSION no apunta a V771/V772/V773/V774/V775/V776/V777/V778 compatible")
