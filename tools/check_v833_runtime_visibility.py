...
def main() -> int:
    os.environ.setdefault("DB_PATH", str(ROOT / "data" / "v833_check_runtime.db"))
    os.environ.setdefault("AUTOMATION_SECRET", "codex-v833-secret")
    os.environ.setdefault("SECRET_KEY", "codex-v833-secret-key")
