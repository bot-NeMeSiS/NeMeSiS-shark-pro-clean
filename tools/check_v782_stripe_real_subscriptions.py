...
def check_files() -> None:
    if not VERSION.startswith(("V782_STRIPE_REAL_SUBSCRIPTIONS_MEMBERSHIP_BILLING","V783_HOME_MEMBERSHIP_CLIENT_EXPERIENCE_COMPACT_FINAL","V784_SMOKE_PREFLIGHT_VALIDATION_FOUNDATION","V785_MEMBERSHIP_STRIPE_FLOW_PRICE_POLISH")):
