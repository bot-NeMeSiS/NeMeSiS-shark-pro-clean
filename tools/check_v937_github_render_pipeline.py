"""Regression guard for the V937 GitHub-to-Render delivery pipeline."""
...
def main() -> int:
    ...
    require(version_text == VERSION, "VERSION.txt is not V937", errors)
    require(VERSION in app_text, "APP_VERSION does not retain V937", errors)
