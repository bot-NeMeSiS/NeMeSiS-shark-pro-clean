...
def main() -> int:
    ...
    checks = {
        "version_txt_v823": read("VERSION.txt").strip() == VERSION,
        "app_version_v823": f"APP_VERSION = '{VERSION}'" in app or f'APP_VERSION = "{VERSION}"' in app,
        "base_meta_v823": f'name="nemesis-version" content="{VERSION}"' in base,
        "base_cache_v823": f"?v={VERSION}" in base,
