...
ok("version_v765", version in {"V765_MARKETS_COMBIS_CLIENT_STRUCTURE_POLISH", "V766_CALENDAR_RESULTS_HIGHLIGHTS_ORDER_AUTOMATION", "V767_MADRID_TIME_EVERYWHERE_CERTIFICATION", "V768_PICK_RESULTS_TRACK_RECORD_TELEGRAM_PRODUCTION_CERTIFICATION", "V769_HIGHLIGHTS_RESULTS_CONTENT_CENTER_FINAL"})
ok("app_version_v765", 'APP_VERSION = "V765_MARKETS_COMBIS_CLIENT_STRUCTURE_POLISH"' in app or 'APP_VERSION = "V766_CALENDAR_RESULTS_HIGHLIGHTS_ORDER_AUTOMATION"' in app or 'APP_VERSION = "V767_MADRID_TIME_EVERYWHERE_CERTIFICATION"' in app or 'APP_VERSION = "V768_PICK_RESULTS_TRACK_RECORD_TELEGRAM_PRODUCTION_CERTIFICATION"' in app or 'APP_VERSION = "V769_HIGHLIGHTS_RESULTS_CONTENT_CENTER_FINAL"' in app)
