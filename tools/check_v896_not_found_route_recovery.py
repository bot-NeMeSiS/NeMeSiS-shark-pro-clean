...
def main() -> int:
    ...
    require("/service-worker.js" in app_py and ("NEMESIS_CACHE_V896" in app_py or "NEMESIS_CACHE_V897" in app_py or "NEMESIS_CACHE_V898" in app_py or "NEMESIS_CACHE_V899" in app_py), "service worker V896/V897/V898/V899 cache missing", failures)
    ...
    require("NEMESIS_CACHE_V896" in sw.get_data(as_text=True) or "NEMESIS_CACHE_V897" in sw.get_data(as_text=True) or "NEMESIS_CACHE_V898" in sw.get_data(as_text=True) or "NEMESIS_CACHE_V899" in sw.get_data(as_text=True), "service worker does not expose V896/V897/V898/V899 cache", failures)
