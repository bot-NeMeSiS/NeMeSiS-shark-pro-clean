...
def main() -> int:
    ...
    failures += not ok("VERSION.txt V814/V815/V816/V817/V819/V820", version in {EXPECTED_VERSION, CURRENT_ACCEPTED_VERSION, CURRENT_V816_VERSION, CURRENT_V817_VERSION, CURRENT_V819_VERSION, CURRENT_V820_VERSION})
