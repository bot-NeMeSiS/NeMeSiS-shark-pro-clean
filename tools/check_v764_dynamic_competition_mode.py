...
NEXT_VERSIONS={"V769_HIGHLIGHTS_RESULTS_CONTENT_CENTER_FINAL", "V768_PICK_RESULTS_TRACK_RECORD_TELEGRAM_PRODUCTION_CERTIFICATION", "V767_MADRID_TIME_EVERYWHERE_CERTIFICATION", "V765_MARKETS_COMBIS_CLIENT_STRUCTURE_POLISH", "V766_CALENDAR_RESULTS_HIGHLIGHTS_ORDER_AUTOMATION"}
def ok(c,m):
    if not c:
