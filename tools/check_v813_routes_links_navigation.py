...
def main() -> int:
    ...
    failures += not ok("shell V813 activo", 'data-v813-shell="true"' in base)
    ...
    failures += not ok("capa visual V813 presente", "V813_CODEX_FULL_ECOSYSTEM_RESTRUCTURE_REFERENCE_SELL_READY" in css)
