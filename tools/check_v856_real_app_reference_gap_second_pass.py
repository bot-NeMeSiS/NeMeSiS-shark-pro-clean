...
VALID_CURRENT_VERSIONS = {VERSION, V857, V858, V859}
...
def main() -> None:
    ...
    ok("V856_REAL_APP_REFERENCE_GAP_SECOND_PASS_TOTAL_REBUILD_FINAL" in base or "V857_COMPANY_OPERATING_SYSTEM_PRODUCT_PERFECTION_FINAL" in base or "V858_VISUAL_DIRECTION_LOCK_FULL_APP_REFERENCE_FINAL" in base or "V859_COMPANY_WIDE_ECOSYSTEM_AUDIT_AND_PRODUCT_BOARD_FINAL" in base, "cache CSS V856/V857/V858/V859", failures)
