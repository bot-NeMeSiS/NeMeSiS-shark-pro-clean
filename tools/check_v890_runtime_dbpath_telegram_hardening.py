...
def main() -> int:
    ...
    require(version_txt == VERSION, "VERSION.txt is not V890", failures)
    require(app_version_file == VERSION, "APP_VERSION is not V890", failures)
    ...
    require(VERSION in base, "base.html V890 cache/version missing", failures)
