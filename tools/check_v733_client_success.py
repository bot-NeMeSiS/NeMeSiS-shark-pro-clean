...
def main() -> int:
    ...
    checks = {
        ...
        "app_version_updated": any(marker in app_text for marker in ["V733_CLIENT_SUCCESS_ONBOARDING_SUPPORT_POLISH", "V734_PUBLIC_LAUNCH_TRACK_RECORD_PAYMENTS_FOUNDATION", "V735_GO_LIVE_PRODUCTION_TELEGRAM_DATA_CERTIFICATION", "V736_GLOBAL_CLIENT_VISUAL_MEMBERSHIP_EXPERIENCE", "V737_NATIVE_APP_FEEL_MICROINTERACTIONS_NAVIGATION_POLISH", "V738_FINAL_COMMERCIAL_RELEASE_CANDIDATE_POLISH", "V739_SALE_READY_HOME_DATA_PRODUCTION_FIX", "V740_CLIENT_VISUAL_PICK_ANALYSIS_PERFECTION", "V741_CALENDAR_SEARCH_EXPERIENCE_PERFECTION", "V742_SALE_READY_LIVE_DETAIL_TRACK_RECORD_TELEGRAM_FINAL_POLISH", "V742_TOP_APP_LIVE_DETAIL_TRACK_RECORD_MATCH_INTELLIGENCE_VIDEO_HIGHLIGHTS_FINAL", "V743_DATA_VAULT_BACKUP_BUSINESS_INTELLIGENCE_PROTECTION", "V744_PRODUCTION_RENDER_TELEGRAM_CERTIFICATION_AND_REAL_QA", "V745_TOP_APP_INTELLIGENCE_ALERTS_DEEP_DATA_COMMERCIAL_POLISH", "V746_ADMIN_TELEGRAM_PRODUCTION_CONTROL_CENTER_FIX", "V747_ADMIN_TELEGRAM_MEMBERSHIP_DAYS_TIME_ORDER_POLISH", "V748_ADMIN_CLIENT_TELEGRAM_SECURITY_PRODUCTION_HOTFIX"]),
