...
def main() -> None:
    ...
    require(read("VERSION.txt").strip() in {VERSION, V866, V867}, "VERSION.txt is not V865/V866/V867")
    require(read("APP_VERSION").strip() in {VERSION, V866, V867}, "APP_VERSION is not V865/V866/V867")
    require(any(f"APP_VERSION = '{candidate}'" in app for candidate in {VERSION, V866, V867}), "app.py APP_VERSION is not V865/V866/V867")
    require("data-v865-shell=\"true\"" in base, "base.html missing data-v865-shell")
    require(VERSION in base or V866 in base or V867 in base, "base.html missing V865/V866/V867 cache marker")
