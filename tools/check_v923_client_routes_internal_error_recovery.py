...
V926_DESKTOP_VERSION = "V926_DESKTOP_REFERENCE_MODEL_COMMAND_CENTER_AND_SPORTS_VALUE_PASS_FINAL"
V927_DESKTOP_VERSION = "V927_PC_DESKTOP_REFERENCE_PERFECTION_ADMIN_CLIENT_SPORTS_FINAL"
V928_CANONICAL_VERSION = "V928_CANONICAL_REFERENCE_FULL_APP_ADMIN_CLIENT_MOBILE_REBUILD_FINAL"
V929_NAVIGATION_VERSION = "V929_NAVIGATION_INTEGRITY_ROUTE_NOT_FOUND_FULL_APP_RECOVERY_FINAL"
ALLOWED_CONTAINER_VERSIONS = {VERSION, V924_MERGE_VERSION, V925_REBUILD_VERSION, V926_DESKTOP_VERSION, V927_DESKTOP_VERSION, V928_CANONICAL_VERSION, V929_NAVIGATION_VERSION}
...
def main() -> int:
    ...
    if local_version not in ALLOWED_CONTAINER_VERSIONS:
        failures.append("VERSION.txt is not V923 recovery or a supported successor release")
