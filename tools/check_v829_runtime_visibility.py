...
def main() -> int:
    os.environ.setdefault("DB_PATH", str(ROOT / "data" / "v829_check_runtime.db"))
    os.environ.setdefault("AUTOMATION_SECRET", "codex-v829-secret")
    os.environ.setdefault("SECRET_KEY", "codex-v829-secret-key")
