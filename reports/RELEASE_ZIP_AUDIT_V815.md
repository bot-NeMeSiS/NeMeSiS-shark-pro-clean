...
- ZIP: `NeMeSiS_SHARK_PRO_V815_RENDER_VISIBLE_REFERENCE_REBUILD_REPO_RECONCILIATION_FINAL_RENDER_READY.zip`
- Archivos: 707
- Tamaño ZIP: 1550668 bytes
- Prohibidos: 0
- Resultado: OK

## Carpetas principales
- `engines`: 83 archivos, 1008263 bytes
- `app.py`: 1 archivos, 809575 bytes
- `static`: 2 archivos, 572018 bytes
- `reports`: 153 archivos, 543405 bytes
- `templates`: 148 archivos, 525673 bytes
- `tools`: 123 archivos, 457227 bytes
- `V726_PROJECT_TREE_AUDIT.md`: 1 archivos, 96394 bytes
- `docs`: 56 archivos, 45463 bytes
- `CHATGPT_CONTINUATION_REPORT.md`: 1 archivos, 27746 bytes
- `V726_PURGE_REPORT.md`: 1 archivos, 26158 bytes

## Archivos pesados
- `app.py`: 809575 bytes
- `static/app.css`: 570692 bytes
