...
- ZIP: `NeMeSiS_SHARK_PRO_V849_FULL_COMPANY_VISUAL_PRODUCT_EXPERIENCE_ADVANCEMENT_RENDER_READY.zip`
- Archivos: 1281
- Tamaño ZIP: 2005891 bytes
- Prohibidos: 0
- Resultado: OK

## Carpetas principales
- `engines`: 89 archivos, 1079712 bytes
- `reports`: 513 archivos, 949492 bytes
- `app.py`: 1 archivos, 847983 bytes
- `static`: 2 archivos, 774147 bytes
- `tools`: 327 archivos, 723868 bytes
- `templates`: 152 archivos, 572582 bytes
