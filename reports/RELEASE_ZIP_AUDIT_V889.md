...
- ZIP: `NeMeSiS_SHARK_PRO_V889_TELEGRAM_PREMIUM_PICKS_INTELLIGENCE_DELIVERY_FINAL_RENDER_READY.zip`
- Archivos: 2000
- Tamaño ZIP: 3773330 bytes
- Prohibidos: 0
- Resultado: OK
...
- `engines`: 108 archivos, 1257835 bytes
- `tools`: 447 archivos, 1108605 bytes
- `static`: 2 archivos, 914372 bytes
- `app.py`: 1 archivos, 911862 bytes
- `templates`: 162 archivos, 629427 bytes
