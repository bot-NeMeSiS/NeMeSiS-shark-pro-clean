...
- ZIP: `NeMeSiS_SHARK_PRO_V853_ADMIN_PC_COMMAND_CENTER_REFERENCE_PERFECTION_FINAL_RENDER_READY.zip`
- Archivos: 1393
- Tamaño ZIP: 2075599 bytes
- Prohibidos: 0
- Resultado: OK

## Carpetas principales
- `engines`: 91 archivos, 1098495 bytes
- `reports`: 570 archivos, 992518 bytes
- `app.py`: 1 archivos, 853148 bytes
- `static`: 2 archivos, 792769 bytes
- `tools`: 379 archivos, 762066 bytes
- `templates`: 153 archivos, 580285 bytes
- `V726_PROJECT_TREE_AUDIT.md`: 1 archivos, 96394 bytes
- `docs`: 56 archivos, 45463 bytes
- `V726_PURGE_REPORT.md`: 1 archivos, 26158 bytes
- `tests`: 11 archivos, 12961 bytes

## Archivos pesados
- `app.py`: 853148 bytes
- `static/app.css`: 791443 bytes
