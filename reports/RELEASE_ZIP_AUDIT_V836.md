...
- ZIP: `NeMeSiS_SHARK_PRO_V836_AUTONOMOUS_REFERENCE_VISUAL_REVIEW_FINAL_QA_RENDER_READY.zip`
- Archivos: 1002
- Tamaño ZIP: 1811035 bytes
- Prohibidos: 0
- Resultado: OK

## Carpetas principales
- `engines`: 86 archivos, 1046044 bytes
- `app.py`: 1 archivos, 832110 bytes
- `reports`: 351 archivos, 794320 bytes
- `static`: 2 archivos, 708619 bytes
- `tools`: 214 archivos, 611854 bytes
- `templates`: 151 archivos, 562830 bytes
