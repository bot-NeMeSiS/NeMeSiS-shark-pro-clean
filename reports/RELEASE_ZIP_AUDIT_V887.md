...
- ZIP: `NeMeSiS_SHARK_PRO_V887_TELEGRAM_QUEUE_SKIPPED_RUNTIME_HOTFIX_FINAL_RENDER_READY.zip`
- Archivos: 1994
- Tamaño ZIP: 3748489 bytes
- Prohibidos: 0
- Resultado: OK
...
- `engines`: 106 archivos, 1216568 bytes
- `tools`: 444 archivos, 1082585 bytes
- `static`: 2 archivos, 913005 bytes
- `app.py`: 1 archivos, 898500 bytes
- `templates`: 161 archivos, 622689 bytes
