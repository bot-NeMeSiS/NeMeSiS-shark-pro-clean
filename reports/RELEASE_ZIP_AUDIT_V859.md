...
- ZIP: `NeMeSiS_SHARK_PRO_V859_COMPANY_WIDE_ECOSYSTEM_AUDIT_AND_PRODUCT_BOARD_FINAL_RENDER_READY.zip`
- Archivos: 1498
- Tamaño ZIP: 2163659 bytes
- Prohibidos: 0
- Resultado: OK

## Carpetas principales
- `engines`: 101 archivos, 1128803 bytes
- `reports`: 639 archivos, 1067441 bytes
- `app.py`: 1 archivos, 857943 bytes
- `static`: 2 archivos, 823323 bytes
- `tools`: 403 archivos, 812799 bytes
- `templates`: 155 archivos, 587011 bytes
- `V726_PROJECT_TREE_AUDIT.md`: 1 archivos, 96394 bytes
- `docs`: 56 archivos, 45463 bytes
- `V726_PURGE_REPORT.md`: 1 archivos, 26158 bytes
- `CHATGPT_CONTINUATION_REPORT.md`: 1 archivos, 14034 bytes

## Archivos pesados
- `app.py`: 857943 bytes
- `static/app.css`: 821997 bytes
