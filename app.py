...
APP_VERSION = 'V875_REAL_PRODUCT_READINESS_RENDER_VISUAL_REVENUE_FINAL'
...
def api_runtime_version():
    ...
    return jsonify(sanitize_runtime_value({
        ...
        "static_css_cache_busting": "V875_REAL_PRODUCT_READINESS_RENDER_VISUAL_REVENUE_FINAL" in base_template,
