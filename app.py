...
APP_VERSION = 'V874_COMPANY_WIDE_PRODUCT_POLISH_VISUAL_DATA_SENTINEL_FINAL'
...
def api_runtime_version():
    ...
    return jsonify(sanitize_runtime_value({
        ...
        "static_css_cache_busting": "V874_COMPANY_WIDE_PRODUCT_POLISH_VISUAL_DATA_SENTINEL_FINAL" in base_template,
