...
def build_membership_experience_matrix() -> dict:
    return {
        "free": {
            ...
            "tone": "entrada útil",
            "accent": "cyan",
            "summary": "Acceso inicial a calendario, estados reales y SHARK básico sin datos inventados.",
            "unlocks": ["Calendario", "Directo", "Estados reales", "SHARK básico"],
            "cta": "Subir a PRO",
        ...
        "pro": {
            ...
            "tone": "valor premium",
            "accent": "blue",
            "summary": "Más SHARK, mejores explicaciones de pronósticos y Telegram como canal de avisos top.",
            "unlocks": ["Pronósticos explicados", "Telegram premium", "Historial", "Soporte prioritario"],
            "cta": "Ver ELITE",
        ...
        "admin": {
            "label": "ADMIN",
            "tone": "centro de mando",
            "accent": "cyan",
            "summary": "Control total de datos, Telegram, SHARK, usuarios, pagos, entorno activo y automatización.",
            "unlocks": ["Datos", "Telegram", "SHARK", "Usuarios", "Pagos", "Automatización maestra"],
