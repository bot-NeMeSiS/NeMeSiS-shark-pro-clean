...
SPANISH_COMPETITION_OVERRIDES = {
    ...
    "english league one": "League One inglesa",
    "english league two": "League Two inglesa",
    "league one": "League One inglesa",
    "league two": "League Two inglesa",
    "national league": "National League inglesa",
    "scottish premiership": "Premiership escocesa",
    "belgian pro league": "Liga belga",
    "austrian bundesliga": "Bundesliga austríaca",
    "swiss super league": "Superliga suiza",
    "turkish super lig": "Superliga turca",
    "greek super league": "Superliga griega",
    "danish superliga": "Superliga danesa",
    "norwegian eliteserien": "Eliteserien noruega",
    "swedish allsvenskan": "Allsvenskan sueca",
    "segunda federacion": "Segunda Federación",
    "segunda federación": "Segunda Federación",
    "primera federacion": "Primera Federación",
    "primera federación": "Primera Federación",
    "tercera federacion": "Tercera Federación",
    "tercera federación": "Tercera Federación",
    "division de honor andaluza": "División de Honor Andaluza",
    "división de honor andaluza": "División de Honor Andaluza",
    "primera andaluza": "Primera Andaluza",
    "segunda andaluza": "Segunda Andaluza",
    "senior andaluza": "Senior Andaluza",
}
