...
def reconcile_autonomous_workforce_evidence(
    ...
    *,
    ...
    founder_specs = [
        ...
        ("founder-shark-identity", "Tiburón no coincidía con la identidad oficial", "visual", "P1", "FIXED_PENDING_VERIFICATION", "Asset y composición corregidos; falta veredicto visual final del fundador.", "La composición debe ser MATCH/CLOSE en revisión humana."),
        ("founder-ocean-background", "Fondo sin profundidad de la referencia", "visual", "P1", "FIXED_PENDING_VERIFICATION", "Capas oceánicas y contraste corregidos; falta veredicto visual final del fundador.", "El fondo debe ser MATCH/CLOSE en PC y móvil."),
        ("founder-false-live-kpi", "KPI LIVE mostraba partidos terminales", "sports", "P0", "FIXED_PENDING_VERIFICATION", "Sports P0 local confirma FT != LIVE; la certificación real sigue en curso.", "0 partidos terminales renderizados como LIVE en producción observada."),
        ("founder-rectangle-fatigue", "Exceso de rectángulos y densidad visual", "visual", "P2", "FIXED_PENDING_VERIFICATION", "Browser QA confirma primer viewport y profundidad <=2; falta aprobación estética humana.", "Producto visible primero, sin fatiga de paneles."),
        ("founder-reference-mismatch", "Desajuste visual frente a referencias oficiales", "visual", "P1", "FIXED_PENDING_VERIFICATION", "16/16 referencias comparadas y clasificación CLOSE; no se declara MATCH sin revisión humana.", "Revisión humana confirma el resultado real renderizado."),
