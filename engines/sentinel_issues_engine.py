...
def reconcile_autonomous_workforce_evidence(
    ...
    *,
    ...
    founder_specs = [
        ...
        ("founder-shark-identity", "Tiburón no coincidía con la identidad oficial", "visual", "P1", "OPEN_REAL", "Comparativa oficial 16/16 y capturas reales preparadas; requiere decisión visual del fundador.", "La composición debe ser MATCH o MINOR_GAP en revisión humana."),
        ("founder-ocean-background", "Fondo sin profundidad de la referencia", "visual", "P1", "OPEN_REAL", "Comparativa oficial de profundidad, iluminación y crop preparada; requiere decisión visual del fundador.", "El fondo debe ser MATCH o MINOR_GAP en PC y móvil."),
        ...
        ("founder-reference-mismatch", "Desajuste visual frente a referencias oficiales", "visual", "P1", "OPEN_REAL", "16/16 referencias comparadas con capturas reales; el resultado queda FOUNDER_REVIEW_REQUIRED, nunca auto-resuelto.", "Revisión humana confirma el resultado real renderizado."),
